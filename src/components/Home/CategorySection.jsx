...
const CategorySection = () => {
  ...
  const categories = [
    { 
      ...
      count: 45, 
      icon: '🥦',
      image: 'https://images.pexels.com/photos/3872399/pexels-photo-3872399.jpeg',
      color: '#27ae60',
      trending: true,
      discount: 15,
    ...
    { 
      ...
      count: 28, 
      icon: '🥛',
      image: 'https://images.pexels.com/photos/6525832/pexels-photo-6525832.jpeg',
      color: '#3498db',
      trending: false,
      discount: 5,
    ...
    { 
      ...
      count: 19, 
      icon: '🍞',
      image: 'https://images.pexels.com/photos/30888604/pexels-photo-30888604.jpeg',
      color: '#d35400',
      trending: true,
      discount: 20,
    ...
    { 
      ...
      count: 42, 
      icon: '🌶️',
      image: 'https://images.pexels.com/photos/32144893/pexels-photo-32144893.jpeg',
      color: '#c0392b',
      trending: false,
      discount: 8,
    ...
    { 
      ...
      count: 54, 
      icon: '🍚',
      image: 'https://images.pexels.com/photos/7421303/pexels-photo-7421303.jpeg',
      color: '#8e44ad',
      trending: false,
      discount: 7,
